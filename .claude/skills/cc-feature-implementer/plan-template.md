...
> **사용 안내**: 이 Template은 `feature-planner` Skill이 자동으로 사용합니다. 수동으로 Plan을 작성할 경우 이 Template을 복사하여 `docs/plans/` 디렉토리에 저장하세요. 각 섹션의 `[placeholder]` 부분을 프로젝트에 맞게 수정하고, Checkbox를 활용하여 진행 상황을 추적합니다.
